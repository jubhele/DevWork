...
-- Resolved after INSERT so they are used consistently below.
...
-- ── 2. SAFETY FILES ───────────────────────────────────────────
-- created_by (text) was dropped by migration_all_person_fk.sql.
-- Use contractor_rep_id, appointee162_id, created_by_id (FK) instead.
INSERT IGNORE INTO bf_safety_files
  (ref_id,contractor,
   contractor_rep,contractor_rep_id,
   appointee162,appointee162_id,
   audit_date,region,audit_team,
   scope_of_work,manpower,supervisors,she_reps,first_aiders,
   auditor_name,sign_off_date,status,score,band,is_active,
   created_by_id,created_at)
VALUES
-- 2025 Base Assessment — opening audit for the year
('SAF-150125-0001',
 'Astute Insights (Pty) Ltd',
 'Jubhele Shange',@jshange_id,
 'Jubhele Shange',@jshange_id,
 ...
 'Approved',26.53,'RED',1,@zmyeza_id,'2025-01-15 10:00:00'),
...
('SAF-120625-0001',
 ...
 'Approved',53.06,'ORANGE',1,@zmyeza_id,'2025-06-12 10:00:00');

-- ── 3a. ITEMS — SAF-150125-0001 (26.53% RED) ─────────────────
-- 13 To Standard / 36 Not to Standard / 37 N/A = 13/49 = 26.53%
-- appointee_id: @jshange_id = Jubhele Shange, @zmyeza_id = Zanele Myeza
--   (covers former Kitso Marupi roles per migration_all_person_fk.sql §7)
-- NULL for external parties (Dr. A. Petersen, Maria Coetzee) and
--   removed seed staff (Refilwe Khumalo, James Mthembu).
DELETE FROM bf_safety_items WHERE file_ref='SAF-150125-0001';
INSERT INTO bf_safety_items
  (file_ref,section_key,item_no,result,appointee_id,comments,ap_status,updated_at)
VALUES
-- SECTION A
('SAF-150125-0001','A',1,'To Standard',@jshange_id,'NOSA grading cert valid. ISO 9001 scope covers security services.','Resolved','2025-01-15 09:00:00'),
...
('SAF-150125-0001','A',4,'To Standard',@jshange_id,'Letter of Good Standing + WCL2. Valid.','Resolved','2025-01-15 09:00:00'),
...
('SAF-150125-0001','A',7,'To Standard',@jshange_id,'Public Liability Insurance — R10M cover, valid to 2025-06-30.','Resolved','2025-01-15 09:00:00'),
('SAF-150125-0001','A',8,'To Standard',@jshange_id,'H&S Policy (Doc 5.01) present. Proof of staff communication outstanding — action raised.','In Progress','2025-01-15 09:00:00'),
('SAF-150125-0001','A',9,'To Standard',@jshange_id,'Company and onsite organogram submitted and current.','Resolved','2025-01-15 09:00:00'),
-- SECTION B
('SAF-150125-0001','B',1,'To Standard',NULL,'Activity list covers perimeter monitoring, CCTV, access control, alarm response, patrols.','Resolved','2025-01-15 09:00:00'),
...
('SAF-150125-0001','B',7,'To Standard',@jshange_id,'SDS for all site materials (cleaning agents, lubricants) on file.','Resolved','2025-01-15 09:00:00'),
-- SECTION C
('SAF-150125-0001','C',1,'To Standard',NULL,'Medical certificates of fitness (Annexure 3) valid for all 3 site staff.','Resolved','2025-01-15 09:00:00'),
...
('SAF-150125-0001','E',8,'To Standard',@zmyeza_id,'24-month incident stats — zero reportable incidents prior period. Confirmed by AECI.','Resolved','2025-01-15 09:00:00'),
...
('SAF-150125-0001','E',11,'To Standard',NULL,'PPE issue records (hard hats, high-vis, safety boots, gloves) for all 3 employees.','Resolved','2025-01-15 09:00:00'),
...
('SAF-150125-0001','H',1,'To Standard',@jshange_id,'S16.2 appointment letter signed and filed.','Resolved','2025-01-15 09:00:00'),
('SAF-150125-0001','H',2,'N/A',NULL,'Construction Manager — N/A: electronic security scope.','Resolved','2025-01-15 09:00:00'),
('SAF-150125-0001','H',3,'Not to Standard',@zmyeza_id,'SHE Rep appointment letter present. No competency certificate. SAMTRAC course enrolled Mar 2025.','Open','2025-01-15 09:00:00'),
...
('SAF-150125-0001','H',11,'Not to Standard',@zmyeza_id,'Risk Assessor appointed. No IRCA/formal qualification certificate yet.','Open','2025-01-15 09:00:00'),
...
('SAF-150125-0001','H',33,'To Standard',NULL,'First Aider — Maria Coetzee. Level 1 cert valid to 2026-01-10.','Resolved','2025-01-15 09:00:00'),
('SAF-150125-0001','H',34,'N/A',NULL,'Radiation Protection Officer — N/A.','Resolved','2025-01-15 09:00:00'),
-- SECTION I bonus
('SAF-150125-0001','I',1,'To Standard',@jshange_id,'PSIRA registration confirmed for all security-grade personnel.','Resolved','2025-01-15 09:00:00'),
...
INSERT INTO bf_safety_items
  (file_ref,section_key,item_no,result,appointee_id,comments,ap_status,updated_at)
VALUES
('SAF-120625-0001','A',1,'To Standard',@jshange_id,'NOSA cert renewed May 2025. ISO 9001 audit passed Feb 2025.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',2,'To Standard',@jshange_id,'SLA and S37.2 signed 2025-02-01. Hard copy and digital copies filed.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',3,'To Standard',@jshange_id,'APS principal contractor appointment letter signed 2025-02-01.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',4,'To Standard',@jshange_id,'Letter of Good Standing renewed Feb 2025. WCL2 updated.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',5,'N/A',NULL,'Construction work permit — N/A.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',6,'To Standard',@jshange_id,'CR3 form signed by AECI and DoL stamp obtained 2025-03-10.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',7,'To Standard',@jshange_id,'PLI renewed — R15M cover, valid to 2026-06-30.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',8,'To Standard',@zmyeza_id,'H&S Policy toolbox 2025-03-15. Signed attendance register filed. Policy poster on site.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','A',9,'To Standard',@jshange_id,'Organogram updated to include N. Sithole (Call Logger).','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','B',1,'To Standard',NULL,'Activity list reviewed and approved. 8 categories listed.','Resolved','2025-06-12 09:00:00'),
...
('SAF-120625-0001','B',3,'To Standard',@zmyeza_id,'Baseline Risk Assessment completed, signed, filed. Reviewed against AECI hazard register.','Resolved','2025-06-12 09:00:00'),
...
('SAF-120625-0001','B',6,'To Standard',NULL,'SOPs completed: CCTV install, access control, fence patrol, ladder safety, working at heights (5 total).','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','B',7,'To Standard',@jshange_id,'SDS library current. All chemical substances covered.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','C',1,'To Standard',NULL,'Medicals renewed. 4 employees — certs valid to Mar 2026.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','C',2,'To Standard',@zmyeza_id,'D&A Policy communicated and signed acknowledgments on file for all 4 staff.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','D',1,'To Standard',NULL,'Induction register complete for all 4 staff. Signed and witnessed.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','D',2,'To Standard',@zmyeza_id,'Training matrix fully populated — all gaps identified and scheduled.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','D',3,'To Standard',@zmyeza_id,'PSIRA certs, first aid cert, fire training certs attached. WaH still outstanding.','Resolved','2025-06-12 09:00:00'),
...
('SAF-120625-0001','D',5,'To Standard',NULL,'Working-at-heights training completed May 2025 (J. Mthembu, R. Khumalo). Certs filed.','Resolved','2025-06-12 09:00:00'),
...
('SAF-120625-0001','E',3,'Not to Standard',NULL,'Fall Protection Plan being drafted. Awaiting Fall Protection Planner qualification.','In Progress','2025-06-12 09:00:00'),
...
('SAF-120625-0001','E',8,'To Standard',@zmyeza_id,'Zero incidents Jan–Jun 2025. Stats current.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','E',9,'To Standard',NULL,'PPE Procedure toolbox talk Apr 2025. Signed attendance register filed.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','E',10,'To Standard',NULL,'PPE training records: all 4 staff trained on limitations, use, and inspection.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','E',11,'To Standard',NULL,'PPE issue register updated — N. Sithole issued Jan 2025.','Resolved','2025-06-12 09:00:00'),
...
('SAF-120625-0001','G',3,'To Standard',NULL,'Fire extinguisher annual service done Apr 2025. Certificate and service report filed.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','H',1,'To Standard',@jshange_id,'S16.2 appointment in place.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','H',2,'N/A',NULL,'Construction Manager — N/A.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','H',3,'Not to Standard',@zmyeza_id,'SAMTRAC course in progress (Mar–Jun 2025). Certificate expected Jul 2025.','In Progress','2025-06-12 09:00:00'),
...
('SAF-120625-0001','H',11,'Not to Standard',@zmyeza_id,'Risk Assessor appointment in place. IRCA qualification still pending — enrolled Aug 2025.','Open','2025-06-12 09:00:00'),
...
('SAF-120625-0001','H',33,'To Standard',NULL,'First Aider cert valid.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','H',34,'N/A',NULL,'Radiation Protection Officer — N/A.','Resolved','2025-06-12 09:00:00'),
('SAF-120625-0001','I',1,'To Standard',@jshange_id,'PSIRA current for all security-grade staff.','Resolved','2025-06-12 09:00:00'),
