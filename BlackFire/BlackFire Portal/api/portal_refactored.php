...
<meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://fonts.gstatic.com; img-src 'self' data:; script-src 'self'; connect-src 'self'; object-src 'none';">
      ...
      <div class="contact-wrap">
        ...
        <div class="contact-form-panel">
          ...
          <div style="margin-top:18px">
            <button class="btn-primary-lg" style="width:100%" data-action="submitContact">Send Request</button>
          </div>
...
<div id="login-screen">
  ...
  <div class="login-card" id="login-panel">
    <div class="login-header">
      <div class="login-mark" data-action="goPublic" style="cursor:pointer" title="Back to home">
    ...
    <div class="login-body">
      ...
      <div style="text-align:center;margin-top:12px">
        <span class="login-back" data-action="showForgotPassword" style="font-size:11px">Forgot password?</span>
        <span style="color:var(--muted);font-size:11px;margin:0 8px">·</span>
        <span class="login-back" data-action="goPublic" style="font-size:11px">Back to site</span>
      </div>
    </div>
  </div>
  ...
  <div class="login-card" id="forgot-panel" style="display:none">
    ...
    <div class="login-body">
      ...
      <div style="text-align:center;margin-top:12px">
        <span class="login-back" data-action="showLoginPanel" style="font-size:11px">Back to sign in</span>
      </div>
    </div>
  </div>
  ...
  <div id="pmain">
    ...
    <div id="p-users" class="ppage">
      ...
      <div id="users-create-bar" style="display:none;margin-bottom:12px">
        <button class="btn btn-g btn-s" data-action="openCreateUserModal" style="background:var(--accent);color:#fff;border:none;padding:8px 18px;cursor:pointer;font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:1.5px;text-transform:uppercase;border-radius:2px">+ New User</button>
      </div>
