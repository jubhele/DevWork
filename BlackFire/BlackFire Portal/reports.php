...
.tbl-wrap{background:var(--surface);border:1px solid var(--border);border-radius:10px;max-height:65vh;overflow:auto;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;margin-bottom:20px}
...
.tbl-wrap > table > thead > tr > th{position:sticky;top:0;z-index:2;background:var(--th-bg);box-shadow:inset 0 -1px 0 var(--border)}
...
@media print{
  ...
  .tbl-wrap > table > thead > tr > th{position:static;box-shadow:none}
}
</style>
</head>
<body>
