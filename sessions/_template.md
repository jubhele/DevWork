...
<!-- The hook will NOT write the closing signature until this is set to ACHIEVED.
     ...
     Exceptions: if the log is inactive for 30+ minutes with core sections filled,
...
## Blockers / Next Steps
- [ ] <incomplete task or follow-up required>

## Learnings
<!-- MANDATORY — fill before ending session. Claude Code: run /learn. All other providers: write here and update memory/ files manually. -->
-
