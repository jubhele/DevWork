...
Astute Insights â€” South African government tender intelligence and proposal automation platform.
Stack: Python 3.11+ (FastAPI, Celery, Playwright, SQLAlchemy) + Next.js 15 + PostgreSQL 16 + pgvector + Redis.

## Mandatory Rules

1. **Session log** â€” every session creates `sessions/Astute Insights_<topic>_YYYYMMDD_HHmmss.md`. Sections: Goal, Decisions, Work Done, Blockers, Learnings. All mandatory.
