...
declare const process:
  | { env?: { NEXT_PUBLIC_API_BASE?: string } }
  | undefined
...
export const auth = {
  ...
  captcha: () =>
    apiFetch<{ success: boolean; message: string; question: string }>('auth.php?action=captcha'),

  login: (username: string, password: string, captcha: number) =>
