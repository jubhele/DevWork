...
- `AGENTS.md` — canonical Codex / Antigravity / fallback constitution.
- `CLAUDE.md` — Claude Code mirror importing `AGENTS.md`.
...
When a provider opens this repo directly, it must follow the repo-local constitution first, then supplement with nested `AGENTS.md` files in app subtrees.
